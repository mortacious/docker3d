...
PARAMETERS="--privileged -e DISPLAY=$DISPLAY --name=$CONTAINER_NAME -h $CONTAINER_NAME -u mortacious -w /home/mortacious -i -t"

[ -c "/dev/nvidiactl" ] && PARAMETERS="$PARAMETERS --device=/dev/nvidiactl:/dev/nvidiactl"
...
PARAMETERS="$PARAMETERS --volume=/home/mortacious/ros_workspace:/home/mortacious/ros_workspace:rw"
